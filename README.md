...
尺寸: 全屏截图或长截图
-->
![完整课程方案](docs/screenshots/complete-course.md)
...
<!--
截图8: FastAPI交互式文档
位置: docs/screenshots/api-docs.png
内容: 打开 http://localhost:8000/docs 后的Swagger UI界面
建议: 展示所有API端点列表，特别突出 /api/v1/generate/stream 端点
尺寸: 1920x1080 或更高
-->
...
<!--
截图4: 输入表单填写示例
位置: docs/screenshots/input-form.png
内容: 左侧输入表单已填写完整的示例（如"AI乐队制作人"课程）
建议: 展示所有字段都已填写的状态，突出显示"生成课程方案"按钮
尺寸: 局部截图，聚焦左侧表单区域
-->
...
<!--
截图5: 项目基础定义部分
位置: docs/screenshots/stage1-foundation.png
内容: Agent 1生成的"项目基础定义"部分
建议: 展示驱动性问题、最终成果、学习目标等内容
尺寸: 局部截图，聚焦这一阶段的输出
-->
...
<!--
截图6: 评估框架部分
位置: docs/screenshots/stage2-assessment.png
内容: Agent 2生成的"评估框架"部分
建议: 展示完整的4级量规表格，清晰可读
尺寸: 局部截图，聚焦这一阶段的输出
-->
...
<!--
截图7: 学习蓝图部分
位置: docs/screenshots/stage3-blueprint.png
内容: Agent 3生成的"学习蓝图"部分
建议: 展示时间线和详细活动安排，体现教学设计的完整性
尺寸: 局部截图，聚焦这一阶段的输出
-->
...
<!--
截图9: 测试运行结果
位置: docs/screenshots/test-results.png
内容: 在终端中运行 uv run pytest app/tests/ -v 的输出结果
建议: 展示所有测试通过的绿色PASSED状态，包括测试覆盖率统计
尺寸: 终端窗口截图，建议1280x720或更高
-->
